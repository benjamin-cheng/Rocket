...
class DailyHuntUtils {
    ...
    companion object {
        ...
        internal fun generateSignatureBase(queryParams: Map<String, String>): String {
        ...
        internal fun calculateRFC2104HMAC(data: String, key: String): String? {
            val result: String?
            try {
                ...
                val s = "Failed to generate HMAC as key is invalid"
                throw SignatureException(s, e)
            } catch (e: NoSuchAlgorithmException) {
                val s = "Failed to generate HMAC as encoding algorithm does not exists"
                throw SignatureException(s, e)
            }
