package org.mozilla.rocket.content.base.view
...
class ContentTabActivity : BaseActivity(),
    ...
    private val LOG_TAG = "ContentTabActivity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var testIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://tw.yahoo.com"))
        handleIntent(testIntent)
        ...
        //screenNavigator.showBrowserScreen("https://tw.yahoo.com", false, false)
        //screenNavigator.raiseBrowserScreen(false)
        observeChromeAction()
